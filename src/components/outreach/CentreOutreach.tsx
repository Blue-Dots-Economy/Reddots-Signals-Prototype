      ...
      {pendingConsent.length > 0 && (
        <>
          <div className={`px-3 sm:px-4 pt-4 sm:pt-5 pb-3 sm:pb-4 ${connected.length > 0 || incomingRequests.length > 0 || incomingHistory.length > 0 ? "border-t border-border" : ""}`}>
            <div className="flex items-center gap-2"><Clock size={18} className="sm:w-5 sm:h-5" style={{ color: "#9F0E2E" }} /><h2 className="text-lg sm:text-xl font-extrabold text-foreground tracking-tight">Providers Reached Out To</h2></div>
